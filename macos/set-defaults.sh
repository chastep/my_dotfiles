...
if command -v duti &> /dev/null; then
  echo "  › Set VS Code as default for JSON files"
  duti -s com.microsoft.VSCode public.json all
  
  echo "  › Set VS Code as default for plain text files"
  duti -s com.microsoft.VSCode public.plain-text all
  
  echo "  › Set VS Code as default for shell scripts"
  duti -s com.microsoft.VSCode public.shell-script all
else
  echo "  › duti not installed, skipping default app settings"
fi
